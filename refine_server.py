...
# make the classes subclass from object
# typical variable names are underscore_separated rather
# than underscoreCamelCase
#
# private vars start with single underscore rather than double
